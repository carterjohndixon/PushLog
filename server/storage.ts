...
export interface IStorage {
  ...
  getOrganizationMembersWithUsers(organizationId: string): Promise<{ userId: string; role: string; joinedAt: string | null; invitedAt: string | null; inviteUsedAt: string | null; inviteType: string | null; displayName: string; username: string | null; email: string | null; lastActiveAt: string | null }[]>;
...
export class MemStorage implements IStorage {
  ...
  async getOrganizationMembersWithUsers(_organizationId: string): Promise<{ userId: string; role: string; joinedAt: string | null; invitedAt: string | null; inviteUsedAt: string | null; inviteType: string | null; displayName: string; username: string | null; email: string | null; lastActiveAt: string | null }[]> {
    return [];
  }

  async removeOrganizationMember(_organizationId: string, _userIdToRemove: string, _actorRole: string): Promise<{ ok: boolean; error?: string }> {
    return { ok: false, error: "Not implemented" };
  }

  async updateOrganizationMemberRole(_organizationId: string, _userId: string, _newRole: string, _actorRole: string): Promise<{ ok: boolean; error?: string }> {
    return { ok: false, error: "Not implemented" };
  }
