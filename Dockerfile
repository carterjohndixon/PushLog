...
# Client: optional surfaces, off unless true (see client/src/lib/features.ts).
ARG VITE_ORGANIZATION_ON
ENV VITE_ORGANIZATION_ON=${VITE_ORGANIZATION_ON}
ARG VITE_INCIDENTS_ON
ENV VITE_INCIDENTS_ON=${VITE_INCIDENTS_ON}
RUN npm run build
