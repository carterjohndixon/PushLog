import { Github, Mail, Code, Coffee } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-blue-50">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <a
              ...
              className="inline-flex items-center justify-center bg-graphite text-white px-8 py-6 rounded-lg hover:bg-gray-700 transition-colors font-semibold text-lg"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center border-2 border-log-green text-log-green px-8 py-6 rounded-lg hover:bg-log-green hover:text-white transition-colors font-semibold text-lg"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-16">
          <div className="bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow border-2 border-gray-100 p-6 text-center">
            <div className="w-16 h-16 bg-log-green rounded-lg mx-auto mb-4 flex items-center justify-center">
              <Code className="text-white text-2xl w-8 h-8" />
            </div>
        ...
        <div className="max-w-3xl mx-auto mt-20">
          <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg border-2 border-gray-100 p-8 md:p-12">
