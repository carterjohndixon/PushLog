  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-graphite mb-4">Sub-Processor Guidelines</h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-semibold text-graphite mb-2">Supabase (PostgreSQL Database)</h3>
              ...
              {/* GitHub */}
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-semibold text-graphite mb-2">GitHub</h3>
                <p className="text-sm text-steel-gray mb-2">
              ...
              {/* Slack */}
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-semibold text-graphite mb-2">Slack</h3>
                <p className="text-sm text-steel-gray mb-2">
              ...
              {/* OpenAI */}
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-semibold text-graphite mb-2">OpenAI</h3>
                <p className="text-sm text-steel-gray mb-2">
              ...
              {/* Stripe */}
              <div className="border-b border-gray-200 pb-4">
                <h3 className="font-semibold text-graphite mb-2">Stripe</h3>
                <p className="text-sm text-steel-gray mb-2">
              ...
              <div>
                <h3 className="font-semibold text-graphite mb-2">Email Service Provider</h3>
                <p className="text-sm text-steel-gray mb-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-steel-gray">
              ...
              <div>
                <h3 className="font-semibold text-graphite mb-2">Selection Criteria:</h3>
              ...
              <div>
                <h3 className="font-semibold text-graphite mb-2">Notification of Changes:</h3>
                <p className="text-sm">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Questions About Sub-Processors?</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-steel-gray">
              <p>
